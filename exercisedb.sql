...
CREATE TABLE IF NOT EXISTS `exercise` (
  ...
  `category` ENUM('BODYWEIGHT', 'WEIGHTS', 'YOGA', 'FUN') NULL,
...
START TRANSACTION;
USE `exercisedb`;
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'Muster Thruster', NULL, 'WEIGHTS', 'You really have to muster all your energy for this, and then some. ', NULL);
...
START TRANSACTION;
USE `exercisedb`;
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'Muster Thruster', 'BEGINNER', 'WEIGHTS', 'You really have to muster all your energy for this, and then some. ', NULL);
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'Holy Snatch!', 'EXPERT', 'WEIGHTS', NULL, NULL);
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, '(You\'ll be) DEADlift', 'BEGINNER', 'WEIGHTS', NULL, NULL);
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'The Dreaded Burpee', 'EXPERT', 'FUN', 'One of the simplest, yet effective bodyweight workouts. Simply put, you throw yourself to lay flat on the ground then throw yourself up in the air like you just don\'t care.', NULL);
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'Squat it Like It\'s Hot', 'EXPERT', 'BODYWEIGHT', NULL, NULL);
...
INSERT INTO `exercise` (`id`, `name`, `skill_level`, `category`, `description`, `link`) VALUES (DEFAULT, 'Garland Pose', 'BEGINNER', 'YOGA', 'Get into a deep squat and place your elbows on the inside of your knees while putting your hands together. This might be helpful after ', NULL);
